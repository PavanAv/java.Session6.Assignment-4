public class StudentProcessingSystem {
	public static void main(String[] args) {
		...
		float res1, res2;			
		Semester1 std1 = new Semester1("pavan", 1001, 10250);				
		Semester2 std2 = new Semester2("PAVAN", 1001, 10250);								
		...
		System.out.println();								
		Semester1 std11 = new Semester1("naresh", 1021, 10550);				
		Semester2 std21 = new Semester2("naresh", 1021, 10550);								
